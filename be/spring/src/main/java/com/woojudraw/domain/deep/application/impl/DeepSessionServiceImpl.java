	...
	public DeepResultResp getDeepResult(Long userId, Long sessionId) {
		...
		List<DeepPsychAssessmentItemResp> assessmentResponses = assessments.stream()
			.map(assessment -> DeepPsychAssessmentItemResp.builder()
				...
				.scorePositive(assessment.getScorePositive() != null ? assessment.getScorePositive().intValue() : null)
				.scoreNegative(assessment.getScoreNegative() != null ? assessment.getScoreNegative().intValue() : null)
				.scoreBalance(assessment.getScoreBalance() != null ? assessment.getScoreBalance().intValue() : null)
